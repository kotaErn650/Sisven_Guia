    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <nav class="navbar bg-cyan-950 mb-4">
                    <form class="container-fluid justify-content-start">
                        ...
                        <button class="btn btn-sm btn-outline-secondary" type="button" 
                            onclick="window.location.href='http://127.0.0.1:8000/municipio'">
                            Ir a Municipios🔜
                        </button>
                        <button class="btn btn-sm btn-outline-secondary" type="button" 
                            onclick="window.location.href='http://127.0.0.1:8000/pais'">
                            Ir a País 🏴
                        </button>
                    </form>
                </nav>
                ...
                <a href="{{ route('comuna.new') }}" class="btn btn-primary mb-3">Agregar Comuna</a>
